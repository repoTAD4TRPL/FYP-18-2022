...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.blade.php">
            ...
            <div class="sidebar-brand-text mx-3">Cent<sup>Pro</sup></div>
        </a>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; CENTPRO 2021/2022</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
...
<script src="{{url('https://cdn.ckeditor.com/4.11.4/standard/ckeditor.js')}}"></script>
